...
import { QuangAuthDownloadModule } from '../../../../@quix/quang/directives/quang-auth-donwload/src/quang-auth-download.module'
import { QuangAuthImageModule } from '../../../../@quix/quang/directives/quang-auth-image/src/quang-auth-image.module'
import { QuangAutocompleteObjModule } from '../../../../@quix/quang/components/autocomplete-obj/src/autocomplete-obj.module'
import { QuangAutocompleteObjAsyncModule } from '../../../../@quix/quang/components/autocomplete-obj-async/src/autocomplete-obj-async.module'
import { QuangAutocompleteStrgModule } from '../../../../@quix/quang/components/autocomplete-strg/src/autocomplete-strg.module'
import { QuangAutocompleteStrgAsyncModule } from '../../../../@quix/quang/components/autocomplete-strg-async/src/autocomplete-strg-async.module'
import { QuangInputCheckboxModule } from '../../../../@quix/quang/components/input-checkbox/src/input-checkbox.module'
import { QuangInputColorModule } from '../../../../@quix/quang/components/input-color/src/input-color.module'
import { QuangDatalistModule } from '../../../../@quix/quang/components/datalist/src/datalist.module'
...
import { QuangInputFractionModule } from '../../../../@quix/quang/components/input-fraction/src/input-fraction.module'
import { QuangMultiSelectObjModule } from '../../../../@quix/quang/components/multi-select-obj/src/multi-select-obj.module'
import { QuangMultiSelectStrgModule } from '../../../../@quix/quang/components/multi-select-strg/src/multi-select-strg.module'
import { QuangInputNumberModule } from '../../../../@quix/quang/components/input-number/src/input-number.module'
import { QuangInputPasswordModule } from '../../../../@quix/quang/components/input-password/src/input-password.module'
import { QuangInputRadioModule } from '../../../../@quix/quang/components/input-radio/src/input-radio.module'
import { QuangInputSearchModule } from '../../../../@quix/quang/components/input-search/src/input-search.module'
import { QuangInputUrlModule } from '../../../../@quix/quang/components/input-url/src/input-url.module'
import { QuangSelectObjModule } from '../../../../@quix/quang/components/select-obj/src/select-obj.module'
import { QuangSelectStrgModule } from '../../../../@quix/quang/components/select-strg/src/select-strg.module'
import { QuangSliderModule } from '../../../../@quix/quang/components/slider/src/slider.module'
...
import { QuangTextAreaModule } from '../../../../@quix/quang/components/text-area/src/text-area.module'
import { QuangTextEditorModule } from '../../../../@quix/quang/components/text-editor/src/text-editor.module'
import { QuangTextViewModule } from '../../../../@quix/quang/components/text-view/src/text-view.module'
import { QuangToggleModule } from '../../../../@quix/quang/components/toggle/src/toggle.module'
import { QuangPaginatorService } from '../../../../@quix/quang/components/paginator/src/paginator.service'
