...
import {
  ...
  selectUserInfo,
  selectUserRoles
} from '../../../../../@quix/quang/auth/src/lib/quang-auth-store/selectors/quang-auth.selectors'
import { QuangAuthModuleState } from '../../../../../@quix/quang/auth/src/lib/quang-auth-module.reducer'
