...
import { QuangInputDateRangeModule } from '../../../../@quix/quang/components/input-date-range/src/input-date-range.module'
import { QuangInputDateTimeModule } from '../../../../@quix/quang/components/input-date-time/src/input-date-time.module'
import { QuangInputTimeModule } from '../../../../@quix/quang/components/input-time/src/input-time.module'
