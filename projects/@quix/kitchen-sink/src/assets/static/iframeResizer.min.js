...
!(function (l) {
  ...
  function n(n) {
    ...
    '[iFrameResizerChild]Ready' === b
      ...
      ? ((g = b.substr(I).split(':')),
        ...
        (v = y.id),
        F[v] && (F[v].loaded = !0),
        (m = y.type in { true: 1, false: 1, undefined: 1 }) && T(v, 'Ignoring init message from meta parent page'),
        !m &&
          ((l = !0), F[(f = v)] || ((l = !1), N(y.type + ' No settings for ' + f + '. Message was: ' + b)), l) &&
          (T(v, 'Received: ' + b),
          (u = !0),
  ...
  function d(i, e) {
    ...
    var t,
      ...
      c =
        ('' === (o = i.id) &&
          ((i.id = ((t = (e && e.id) || p.id + m++), null !== document.getElementById(t) && (t += m++), (o = t))),
          (g = (e || {}).log),
        ...
        switch (
          ...
          (function (e) {
            e &&
              ...
              N('enablePublicMethods option has been removed, public methods are now always available in the iFrame')
          })(e),
          typeof n)
        ) {
          case 'undefined':
