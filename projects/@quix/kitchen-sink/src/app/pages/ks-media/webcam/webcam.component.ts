...
export class WebcamComponent {
  ...
  @ViewChild('video', { static: true }) video: ElementRef<HTMLVideoElement> | undefined = undefined
  ...
  checkWebcamVideo(v: Blob | MediaSource): void {
    this.videoFile = this.sanitizer.bypassSecurityTrustResourceUrl(URL.createObjectURL(v))
  }
