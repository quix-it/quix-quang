...
@NgModule({
  declarations: [ConfigComponent, DirectiveComponent, SelectorComponent, GuardComponent],
  imports: [CommonModule, KsKeycloakRoutingModule, SharedModule, QuangCardsModule, TranslocoModule],
