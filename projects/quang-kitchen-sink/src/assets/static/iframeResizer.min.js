    ...
    '[iFrameResizerChild]Ready' === b
      ...
      ? ((g = b.substr(I).split(':')),
        ...
        !m &&
          ...
          F[(f = v)] ||
            ((l = !1),
            N(y.type + ' No settings for ' + f + '. Message was: ' + b)),
          l) &&
          (T(v, 'Received: ' + b),
          (u = !0),
          null === y.iframe &&
            (N(v, 'IFrame (' + y.id + ') not found'), (u = !1)),
          u &&
            (function () {
              var e,
                i = n.origin,
            ...
            (function () {
              switch (
                (F[v] && F[v].firstRun && F[v] && (F[v].firstRun = !1), y.type)
              ) {
                case 'close':
                  C(y.iframe)
                  break
                    ...
                    (function () {
                      function e(n, i) {
                        ...
                        ;['scroll', 'resize'].forEach(function (e) {
                          T(r, n + e + ' listener for sendPageInfo'),
                            i(window, e, t)
                        })
                      }
                      function o() {
      ...
      !(function (e) {
        n.id
          ? ((n.iframe.style[e] = n[e] + 'px'),
            T(n.id, 'IFrame (' + t + ') ' + e + ' set to ' + n[e] + 'px'))
  ...
  function d(i, e) {
    ...
    c in F && 'iFrameResizer' in i
      ...
      : ((d = (d = e) || {}),
        ...
        (function (e) {
          for (var n in p)
            Object.prototype.hasOwnProperty.call(p, n) &&
              (F[c][n] = Object.prototype.hasOwnProperty.call(e, n)
                ? e[n]
                : p[n])
        })(d),
        F[c] &&
        ...
        (function () {
          switch (
            (T(
              c,
              'IFrame scrolling ' +
                (F[c] && F[c].scrolling ? 'enabled' : 'disabled') +
                ' for ' +
                c
            ),
            (i.style.overflow =
              !1 === (F[c] && F[c].scrolling) ? 'hidden' : 'auto'),
            F[c] && F[c].scrolling)
          ) {
            case 'omit':
              break
        ...
        u('maxWidth'),
        u('minWidth'),
        ('number' != typeof (F[c] && F[c].bodyMargin) &&
          '0' !== (F[c] && F[c].bodyMargin)) ||
          ((F[c].bodyMarginV1 = F[c].bodyMargin),
          (F[c].bodyMargin = F[c].bodyMargin + 'px')),
        (r = q(c)),
        (s = w()) &&
          ((a = s),
          i.parentNode &&
