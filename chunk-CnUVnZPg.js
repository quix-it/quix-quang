...
export class FormLiveExampleComponent {
  ...
  <button type="submit">Submit</button>
</form>`;var me=(()=>{class o{constructor(){this.liveExampleTs=q,this.liveExampleHtml=w;}static{this.\u0275fac=function(e){return new(e||o)};}static{this.\u0275cmp=JI({type:o,selectors:[["playground-form-example-showcase"]],decls:10,vars:14,consts:[[1,"playground-showcase","form-showcase"],[1,"showcase-header"],[3,"description","htmlCode","title","tsCode"]],template:function(e,t){e&1&&(ui(0,"div",0)(1,"div",1)(2,"h2"),mD(3),OD(4,"transloco"),OD(5,"transloco"),Rc()(),ui(6,"playground-example-viewer",2),OD(7,"transloco"),OD(8,"transloco"),yp(9,"playground-form-live-example"),Rc()()),e&2&&(gv(3),Fp("",LD(4,6,"menu.form")," / ",LD(5,8,"menu.formExample")),gv(3),mp("description",LD(7,10,"form.showcase.liveExample.description"))("htmlCode",t.liveExampleHtml)("title",LD(8,12,"form.showcase.liveExample.title"))("tsCode",t.liveExampleTs));},dependencies:[Ti,E,Ol],encapsulation:2});}}return o})();var ue=o=>({$implicit:o});function ce(o,M){if(o&1&&Ep(0,3),o&2){let a=M.$implicit;VE();let e=zE(9);mp("ngTemplateOutlet",e)("ngTemplateOutletContext",SD(2,ue,a));}}function de(o,M){if(o&1){let a=RE();ui(0,"div",4)(1,"div",5)(2,"h5"),mD(3),Rc(),ui(4,"button",6),OD(5,"transloco"),wp("click",function(){let t=mu(a).$implicit,y=VE();return yu(y.copyToClipboard(t.import,t.exampleUsage))}),yp(6,"svg-icon",7),Rc()(),ui(7,"div",8)(8,"p"),mD(9),OD(10,"transloco"),Rc(),ui(11,"pre"),mD(12,"          "),ui(13,"span",9),mD(14),Rc(),mD(15,`
          `),ui(16,"span"),mD(17),Rc(),mD(18,`
      `),Rc()()();}if(o&2){let a=M.$implicit,e=VE();gv(3),Lp(a.functionName),gv(),mp("quangTooltip",LD(5,5,e.buttonTooltip())),gv(5),Lp(LD(10,7,a.explanationKey)),gv(5),Lp(a.import),gv(3),Lp(a.exampleUsage);}}var pe=(()=>{class o{constructor(){this.buttonTooltip=Ro("utils.copyContent"),this.formFunctions=[{functionName:"fileMaxSize",import:"import { fileMaxSize } from 'quang/forms/validators';",exampleUsage:`this.formBuilder.group({
